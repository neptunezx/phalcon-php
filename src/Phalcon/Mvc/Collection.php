...
class Collection implements EntityInterface, CollectionInterface, InjectionAwareInterface, Serializable
{
     ...
     * @throws Exception
     */
    final public function __construct(DiInterface $dependencyInjector = null, ManagerInterface $modelsManager = null)
    {
     ...
     * @throws Exception
     */
    protected static function _getGroupResultset($params, CollectionInterface $collection, $connection)
    {
        /* Type check */
