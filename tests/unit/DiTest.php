...
class DiTest extends UnitTest
{
    ...
    {
        $this->specify(
            "Registering a service via string does now work correctly", function () {
    ...
    {
        $this->specify(
            "Registering a service via anonymous function does now work correctly", function () {
    ...
    {
        $this->specify(
            "Registering a service via array does now work correctly", function () {
    ...
    {
        $this->specify(
            "Registering a service in the services container via Di::attempt does now work correctly", function () {
    ...
    {
        $this->specify(
            "Check a service in the services container via Di::attempt does now work correctly", function () {
    ...
    {
        $this->specify(
            "Resolving shared service does now work correctly", function () {
    ...
    {
        $this->specify(
            "Resolving service via magic __get does now work correctly", function () {
    ...
    {
        $this->specify(
            "Registering a service via magic __set does now work correctly", function () {
    ...
    {
        $this->specify(
            "Registering a service with parameters does now work correctly", function () {
    ...
    {
        $this->specify(
            "Getting services does now work correctly", function () {
            $expectedServices = [
    ...
    {
        $this->specify(
            "Getting raw services does now work correctly", function () {
            $this->phDi->set('service1', 'some-service');
    ...
    {
        $this->specify(
            "Registering a services via array access does now work correctly", function () {
    ...
    {
        $this->specify(
            "Resolving a services via array access does now work correctly", function () {
    ...
    {
        $this->specify(
            "Getting non-existent service does not throws exception with expected message", function () {
    ...
    {
        $this->specify(
            "Di::getDefault does not return the latest DI created", function () {
    ...
    {
        $this->specify(
            'Registering services by using service provider does not work as expected', function () {
    ...
    public function testYamlLoader()
    {
        ...
        $this->specify(
            '"Di does not load services from yaml files properly', function () {
    ...
    {
        $this->specify(
            'Di does not load services from php files properly', function () {
