...
class RequestTest extends HttpBase
{
    ...
    {
        $this->specify(
            "The new object is not the correct class", function () {
    ...
    {
        $this->specify(
            "Empty header does not contain correct data", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "getHeaders does not returns correct header values", function () {
    ...
    {
        $this->specify(
            "Default request is Ajax", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "Default scheme is not http", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "Default isSecureRequest is true", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "isSecureRequest is not true", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'on');
    ...
    {
        $this->specify(
            "Default isSoapRequest is true", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "isSoapRequest is not true", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "default server address is not 127.0.0.1", function () {
            $request = $this->getRequestObject();
            ...
            expect($request->getServerAddress())->equals($expected);
        }
        );
    }
    ...
    {
        $this->specify(
            "server address does not contain correct IP", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "http host with empty server values does not return empty string", function () {
            $request = $this->getRequestObject();
        ...
        $this->specify(
            "http host without required server values does not return empty string", function () {
            $request = $this->getRequestObject();
        ...
        $this->specify(
            "The Request::getHttpHost without strict validation does not return expected host", function () {
            $request = $this->getRequestObject();
        ...
        $this->specify(
            "http host without http does not contain correct data", function () {
            $request = $this->getRequestObject();
        ...
        $this->specify(
            "http host with http does not contain correct data", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'on');
            $this->setServerVar('SERVER_NAME', 'localhost');
            $this->setServerVar('SERVER_PORT', 80);
        ...
        $this->specify(
            "http host with https and 443 port does not contain correct data", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'on');
            $this->setServerVar('SERVER_NAME', 'localhost');
        ...
        $this->specify(
            "http host with SERVER_ADDR value does not return expected host name", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTP_HOST', '');
            $this->setServerVar('SERVER_NAME', '');
        ...
        $this->specify(
            "http host with SERVER_NAME value does not return expected host name", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTP_HOST', '');
        ...
        $this->specify(
            "http host with HTTP_HOST value does not return expected host name", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "http host with strict param does not return does not return valid host name", function () {
            $request = $this->getRequestObject();
        ...
        $this->specify(
            "The Request::isStrictHostCheck does not return expected value", function () {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "http host with https on does not return expected port", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'on');
            $this->setServerVar('HTTP_HOST', 'example.com');
        ...
        $this->specify(
            "http host with https off does not return expected port", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'off');
            $this->setServerVar('HTTP_HOST', 'example.com');
        ...
        $this->specify(
            "http host with port on HTTP_HOST does not return expected port", function () {
            $request = $this->getRequestObject();
            $this->setServerVar('HTTPS', 'off');
    ...
    {
        $this->specify(
            "The Request::getHttpHost does not throws exception on strict host validation", function ($host) {
            $request = $this->getRequestObject();
            $request->setStrictHostCheck(true);
    ...
    {
        $this->specify(
            "hasPost for empty element returns incorrect results", function () {
            $this->hasEmpty('hasPost');
        }
        );

        $this->specify(
            "hasPost for set element returns incorrect results", function () {
            $this->hasNotEmpty('hasPost', 'setPostVar');
        }
        );

        $this->specify(
            "getPost for empty element returns incorrect results", function () {
            $this->getEmpty('getPost');
        }
        );

        $this->specify(
            "getPost returns incorrect results", function () {
            $this->getNotEmpty('getPost', 'setPostVar');
        }
        );

        $this->specify(
            "getPost does not return sanitized data", function () {
            $this->getSanitized('getPost', 'setPostVar');
        }
        );

        $this->specify(
            "getPost with array as filter does not return sanitized data", function () {
    ...
    {
        $this->specify(
            "hasQuery for empty element returns incorrect results", function () {
            $this->hasEmpty('hasQuery');
        }
        );

        $this->specify(
            "hasQuery for set element returns incorrect results", function () {
            $this->hasNotEmpty('hasQuery', 'setGetVar');
        }
        );

        $this->specify(
            "getQuery for empty element returns incorrect results", function () {
            $this->getEmpty('getQuery');
        }
        );

        $this->specify(
            "getQuery returns incorrect results", function () {
            $this->getNotEmpty('getQuery', 'setGetVar');
        }
        );

        $this->specify(
            "getQuery does not return sanitized data", function () {
            $this->getSanitized('getQuery', 'setGetVar');
        }
        );

        $this->specify(
            "getQuery with array as filter does not return sanitized data", function () {
    ...
    {
        $this->specify(
            "has for empty element returns incorrect results", function () {
            $this->hasEmpty('has');
        }
        );

        $this->specify(
            "has for set element returns incorrect results", function () {
            $this->hasNotEmpty('has', 'setRequestVar');
        }
        );

        $this->specify(
            "get for empty element returns incorrect results", function () {
            $this->getEmpty('get');
        }
        );

        $this->specify(
            "get returns incorrect results", function () {
            $this->getNotEmpty('get', 'setRequestVar');
        }
        );

        $this->specify(
            "get does not return sanitized data", function () {
            $this->getSanitized('get', 'setRequestVar');
        }
        );

        $this->specify(
            "get with array as filter does not return sanitized data", function () {
    ...
    {
        $this->specify(
            'The request object gets http method incorrectly', function ($header, $method, $expected) {
            $_SERVER['REQUEST_METHOD'] = 'POST';
            $request                   = $this->getRequestObject();
...
//        $this->assertEquals(null, $request->getPost('array', 'string', null, true, true));
    ...
    public function testRequestGetQuery()
    {
        ...
        $this->specify(
            "Request::getQuery does not return correct result", function ($function) {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "Request::hasFiles does not return correct result", function ($files, $all, $onlySuccessful) {
            $request = $this->getRequestObject();
    ...
    {
        $this->specify(
            "Request does not handle uploaded files correctly", function () {
            $request = $this->getRequestObject();
