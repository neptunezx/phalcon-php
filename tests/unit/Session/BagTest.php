...
class BagTest extends UnitTest
{
    ...
    {
        $this->specify(
            "Session bag incorrectly handling writing and reading", function () {
    ...
    {
        $this->specify(
            "Setting an empty array to Session Bag do not return the same", function () {
    ...
    {
        $this->specify(
            "Delete a value in a non initialized bag has failed", function () {
